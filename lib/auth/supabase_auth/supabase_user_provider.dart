...
class AppMecanicosSupabaseUser extends BaseAuthUser {
  AppMecanicosSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> appMecanicosSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = AppMecanicosSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
